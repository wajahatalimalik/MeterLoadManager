        ...
        NavHost(nav, startDestination = Screen.Dashboard.route, Modifier.padding(pad)) {
            composable(Screen.Dashboard.route) {
                DashboardScreen(dashVM,
                    onAddReading = { nav.navigate(Screen.Reading.route) },
                    onAlerts = { nav.navigate(Screen.Alerts.route) })
            }
            ...
            composable(Screen.Alerts.route)     { AlertsScreen(alrtVM, dashVM) }
        }
    }
}
